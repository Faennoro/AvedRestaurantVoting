...
VALUES ('KFC', 'ул. Первая 10', '2019-08-10'),
       ('Royal', 'ул. Вторая 12', '2019-08-10'),
       ('KFC', 'ул. Первая 10', '2019-08-11'),
       ('Вилка-Ложка', 'ул. Пятая 13', '2019-08-11');
...
VALUES ('2019-08-10', 1, 100002),
       ('2019-08-10',1,100003),
       ('2019-08-11', 2, 100004),
       ('2019-08-11',0,100005);

INSERT INTO USER_VOTE_HISTORY(date, USER_ID, RESTAURANT_ID)
values ('2019-08-10', 100000, 100002),
       ('2019-08-10',100001,100003),
       ('2019-08-11', 100000, 100004),
       ('2019-08-11',100001,100005);